...
import { Zap, ShieldCheck, Clock, CircleDollarSign } from 'lucide-react';
...
export default function Home() {
  ...
  const monthlyPayment = useMemo(() => {
    const p = amount[0];
    const n = months[0];
    // simple interest: amount * (1 + 0.015 * months) / months
    ...
    <PageTransition className="pb-10">
      ...
      <section className="px-6 pt-8 pb-10">
        <h1 className="text-4xl font-extrabold text-slate-900 leading-[1.1] mb-4">
          Get Your Loan<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500">Approved Fast</span>
        </h1>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-orange-50">
          <div className="mb-6">
            <div className="flex justify-between items-end mb-4">
              <label className="text-sm font-semibold text-slate-600 uppercase tracking-wider">Loan Amount</label>
          ...
          <div className="mb-8">
            <div className="flex justify-between items-end mb-4">
              <label className="text-sm font-semibold text-slate-600 uppercase tracking-wider">Loan Term</label>
          ...
          <div className="bg-orange-50 rounded-2xl p-5 mb-6">
            <div className="text-sm text-orange-800 font-medium mb-1">Estimated Monthly Payment</div>
      ...
      <section className="px-6 py-8 bg-slate-50 mt-auto rounded-t-[40px]">
        <div className="space-y-4">
          <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm">
            ...
            <div>
              <h3 className="font-bold text-slate-900">Fast Approval</h3>
              <p className="text-sm text-slate-500 font-medium mt-1">Get approved in minutes, not days.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium mt-1">Competitive rates starting at 1.5%.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium mt-1">Bank-level security for your data.</p>
            </div>
          </div>
        </div>
      </section>
